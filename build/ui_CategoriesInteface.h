/********************************************************************************
** Form generated from reading UI file 'CategoriesInteface.ui'
**
...
#ifndef UI_CATEGORIESINTEFACE_H
#define UI_CATEGORIESINTEFACE_H
...
public:
    ...
    void setupUi(QWidget *CategoriesInteface)
    {
        if (CategoriesInteface->objectName().isEmpty())
            CategoriesInteface->setObjectName(QStringLiteral("CategoriesInteface"));
        CategoriesInteface->resize(300, 470);
        CategoriesInteface->setMinimumSize(QSize(300, 470));
        CategoriesInteface->setMaximumSize(QSize(300, 470));
        CategoriesInteface->setLocale(QLocale(QLocale::Portuguese, QLocale::Brazil));
        layoutWidget = new QWidget(CategoriesInteface);
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/edit"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/remove"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/add"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        retranslateUi(CategoriesInteface);

        addButton->setDefault(false);


        QMetaObject::connectSlotsByName(CategoriesInteface);
    } // setupUi

    void retranslateUi(QWidget *CategoriesInteface)
    {
        CategoriesInteface->setWindowTitle(QApplication::translate("CategoriesInteface", "Categorias", 0));
...
namespace Ui {
    class CategoriesInteface: public Ui_CategoriesInteface {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CATEGORIESINTEFACE_H
