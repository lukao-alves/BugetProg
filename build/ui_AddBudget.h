...
public:
    ...
    void setupUi(QWidget *AddBudget)
    {
        ...
        AddBudget->setWindowModality(Qt::NonModal);
        AddBudget->setEnabled(true);
        AddBudget->resize(350, 420);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(AddBudget->sizePolicy().hasHeightForWidth());
        AddBudget->setSizePolicy(sizePolicy);
        AddBudget->setMinimumSize(QSize(350, 290));
        AddBudget->setMaximumSize(QSize(350, 420));
        AddBudget->setLocale(QLocale(QLocale::Portuguese, QLocale::Brazil));
        layoutWidget = new QWidget(AddBudget);
        ...
        QObject::connect(cancelButton, SIGNAL(clicked()), AddBudget, SLOT(close()));
    ...
    {
        AddBudget->setWindowTitle(QApplication::translate("AddBudget", "AddBudget", 0));
        budgetTypeLabel->setText(QApplication::translate("AddBudget", "Forma de Pagamento", 0));
        budgetType->clear();
        budgetType->insertItems(0, QStringList()
         << QApplication::translate("AddBudget", "-", 0)
         << QApplication::translate("AddBudget", "Dinheiro", 0)
         << QApplication::translate("AddBudget", "D\303\251bito em Conta", 0)
         << QApplication::translate("AddBudget", "Cart\303\243o de Cr\303\251dito", 0)
        );
#ifndef QT_NO_STATUSTIP
        budgetType->setStatusTip(QString());
#endif // QT_NO_STATUSTIP
        budgetType->setCurrentText(QApplication::translate("AddBudget", "-", 0));
        bank_issuerLabel->setText(QApplication::translate("AddBudget", "Banco", 0));
        bank_issuer->clear();
        bank_issuer->insertItems(0, QStringList()
         << QApplication::translate("AddBudget", "-", 0)
        );
        numberLabel->setText(QApplication::translate("AddBudget", "Ag\303\252ncia", 0));
        number->clear();
        number->insertItems(0, QStringList()
         << QApplication::translate("AddBudget", "-", 0)
        );
        categoryLabel->setText(QApplication::translate("AddBudget", "Categoria", 0));
        category->clear();
        category->insertItems(0, QStringList()
         << QApplication::translate("AddBudget", "-", 0)
        );
        subCategoryLabel->setText(QApplication::translate("AddBudget", "Sub Categoria", 0));
        subCategory->clear();
        subCategory->insertItems(0, QStringList()
         << QApplication::translate("AddBudget", "-", 0)
        );
        budgetDateLabel->setText(QApplication::translate("AddBudget", "Data", 0));
#ifndef QT_NO_WHATSTHIS
        budgetDate->setWhatsThis(QString());
#endif // QT_NO_WHATSTHIS
        budgetDate->setDisplayFormat(QApplication::translate("AddBudget", "dd/MM/yyyy", 0));
        budgetValueLabel->setText(QApplication::translate("AddBudget", "Valor", 0));
        currency->setText(QApplication::translate("AddBudget", "R$", 0));
        budgetValue->setText(QString());
        budgetValue->setPlaceholderText(QApplication::translate("AddBudget", "Valor", 0));
        installmentLabel->setText(QApplication::translate("AddBudget", "Quantidade de Parcelas", 0));
        cancelButton->setText(QApplication::translate("AddBudget", "Cancelar", 0));
        cancelButton->setShortcut(QApplication::translate("AddBudget", "Esc", 0));
        addButton->setText(QApplication::translate("AddBudget", "Adicionar", 0));
        addButton->setShortcut(QApplication::translate("AddBudget", "Return", 0));
    } // retranslateUi
